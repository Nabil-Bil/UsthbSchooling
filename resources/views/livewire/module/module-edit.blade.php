      ...
      @endif
        <div class="mb-3 row">
          ...
          <div class="col-sm-10 d-flex" >
            <input type="text" class="form-control" id="code module"  wire:model.lazy="codeM"  name="codeM" {{ $codeM_readonly }}>
          ...
          <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="libellè" name="libellè" wire:model.lazy='module.libelléM' {{ $readonly }}>
              </div>
          </div>
          <div class="mb-3 row">
              <label for="coef" class="col-sm-2 col-form-label">coefficient</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="coef" name="coef" wire:model.lazy='module.coef' {{ $readonly }}>
              </div>
          </div>
          <div class="mb-3 row">
              <label for="section" class="col-sm-2 col-form-label">Enseignant</label>
              <div class="col-sm-10">
                <select type="text" class="form-select" id="section"  wire:model.lazy='module.codeEns' name="enseignant">
